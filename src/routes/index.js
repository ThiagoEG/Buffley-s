...
const iconesDasGuias = {
  ...
  const iconesDasGuias2 = {
    ...
    PerfilBuffet: 'business', // Substitua 'person' pelo nome real do ícone que você deseja usar
    Funcionários: 'clipboard-outline', // Substitua 'settings' pelo nome real do ícone que você deseja usar
  };
  ...
  function HomeScreenBuffet() {
    return (
      ...
      >
        ...
        <Tab.Screen name="PerfilBuffet" component={TelaLucas1} options={{headerShown: false}}/>
        <Tab.Screen name="Funcionários" component={TelaLucas2} options={{headerShown: false}}/>
      </Tab.Navigator>
    );
  }  
